...
if len(sys.argv) > 1: gamedb_file = sys.argv[1]
    ...
    sys.exit()
ignore_list = ["BeforeDraw", "bilinearUpscale", "cpuSpriteRenderLevel", "eeCycleRate", "GetSkipCount", "eeDivRoundMode", "gpuTargetCLUT", "maximumBlendingLevel", "minimumBlendingLevel", "name-sort", "nativePaletteDraw", "partialTargetInvalidation", "recommendedBlendingLevel"]
replace_dic = {"mtvu:": "MTVUSpeedHack:", "mvuFlag:": "mvuFlagSpeedHack:", "instantVU1:": "InstantVU1SpeedHack:", "autoFlush: 2": "autoFlush: 1", "name-en:": "name:"}
