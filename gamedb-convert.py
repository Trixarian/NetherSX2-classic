...
ignore_list = ['accurateAlphaTest', 'beforeDraw', 'bilinearUpscale', 'cpuSpriteRenderLevel', 'eeCycleRate', 'getSkipCount', 'gpuTargetCLUT', 'limit24BitDepth', 'maximumBlendingLevel', 'minimumBlendingLevel', 'name-sort', 'nativePaletteDraw', 'nativeScaling', 'partialTargetInvalidation', 'PCRTCOffsets', 'PCRTCOverscan', 'readTCOnClose', 'recommendedBlendingLevel']
